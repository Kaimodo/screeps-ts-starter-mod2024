...
The Changelog can be found ([here](_media/CHANGELOG.md))
...
Issues, Pull Requests, and contribution to the docs are welcome! See our [Contributing Guidelines](_media/CONTRIBUTING.md) for more details.
