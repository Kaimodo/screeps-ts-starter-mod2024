...
export class Visualizer {
  ...
  static displayCostMatrix(matrix: CostMatrix, roomName?: string, opts = { dots: true, displayZero: true }): void {
  ...
  static popupBox(info: string[], calledFrom: { room: Room | undefined; pos: RoomPosition }, opts = {}): RoomVisual {
    if (calledFrom.room) {
